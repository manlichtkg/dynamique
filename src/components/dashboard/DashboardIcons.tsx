...
export const Icons = {
    ...
    Flame: ({ className }: { className?: string }) => (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
            <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-2.312-5.185-1.5-8C19.5 8 20.5 11 19.5 15c-.5 2.5-2.5 5-5.5 5h-.105a5 5 0 0 1-5.395-5z" />
            <path d="M8.5 14.5c.5-1.5 2.5-3 4-2.5" />
        </svg>
    ),
