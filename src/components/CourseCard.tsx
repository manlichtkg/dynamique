...
export default function CourseCard({ id, title, author, lessons, duration, category, rating, image }: Props) {
	const imgSrc =
		image ||
	...
	return (
		...
		>
			<div className="relative">
				<img src={imgSrc} alt={title} className="w-full h-40 object-cover sm:h-44 group-hover:scale-105 transition-transform duration-500" />
				{category && (
